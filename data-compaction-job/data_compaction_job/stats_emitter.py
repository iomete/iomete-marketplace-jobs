    ...
    def decorator(func):
        ...
        def wrapper_func(*args, **kwargs):
            ...
            try:
                ...
                spark.sql(
                    f"""INSERT INTO spark_catalog.iomete_system_db.table_optimisation_run_errors VALUES (
                ...
                sql = sql.replace("'", "''")
                spark.sql(
                    f"""INSERT INTO spark_catalog.iomete_system_db.table_optimisation_run_metrics VALUES (
      '{spark.sparkContext.applicationId}',
      '{args[1]}',
      '{args[2]}',
      '{args[3]}',
...
def init_emitter(spark: SparkSession):
    ...
    spark.sql(
        """create TABLE IF NOT EXISTS spark_catalog.iomete_system_db.table_optimisation_run_metrics (
  ...
  'commit.retry.num-retries' = '200'
    ...
    spark.sql(
        """create TABLE IF NOT EXISTS spark_catalog.iomete_system_db.table_optimisation_run_errors(
  spark_app_id VARCHAR(255),
  catalog_name VARCHAR(255),
  database_name VARCHAR(255),
  table_name VARCHAR(255),
